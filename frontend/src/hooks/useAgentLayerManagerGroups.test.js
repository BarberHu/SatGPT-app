...
const createOptions = () => ({
  ...
  fetchAgentRasterLayer: jest.fn(),
  getCatalogLayerDateWindow: jest.fn(),
  getRecommendedLayerContextKey: jest.fn(),
  handleAgentRasterDownload: jest.fn(),
  hotspotYearRange: DEFAULT_HOTSPOT_YEAR_RANGE,
  layerData: {},
  rasterDownloadState: {},
  removeMapLayerFromMap: jest.fn(),
  selectedAoiSignature: 'aoi-1',
  setAgentRasterLayerVisibility: jest.fn(),
  setAgentRecommendedLayerVisibility: jest.fn(),
  setAgentShowFloodDetection: jest.fn(),
  setCatalogLayerTimeOverrides: jest.fn(),
  setHotspotYearRange: jest.fn(),
  setSingleInundationTimeWindow: jest.fn(),
  setWarning: jest.fn(),
